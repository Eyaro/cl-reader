...
(defstruct (cl-readtable (:conc-name nil)
                         (:predicate cl-readtablep)
...
types for the Common Lisp expression reader."
  ...
  ;;TODO: undefined-macro-char in reader.lisp
  (character-macro-array
   (make-array +base-char-code-limit+ :initial-element 
               nil ;#'undefined-macro-char
               )
